...
function Marquees() {
  ...
  return (
    <div className='py-20 lg:mt-20 lg:py-28'>
        {data.map((item, index) => <Marquee direction={index===0?"left" : "right"} key={index} imagesurl={item}/>)}
    </div>
  )
}
